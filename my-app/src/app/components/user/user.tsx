...
import styles from "@/app/components/user/user.module.css";
...
function ProfilePage({ onToggleComponent, onHome, componentStates  }: ProfileProps) {
    const {
        data: userData,
        loading: userLoading,
        error: userError
 ...
 const {
    ...
    return (
        ...
        <div className={styles.UserPage}>
            ...
            {user && <div className={styles.UserName}>{user.firstName} {user.lastName}</div>}
